...
class MeditationsControllerTest < ActionController::TestCase
  ...
  test "should create meditation" do
    assert_difference('Meditation.count') do
      post :create, meditation: { description: @meditation.description, file: @meditation.file, title: @meditation.title }
    end
  ...
  test "should update meditation" do
    patch :update, id: @meditation, meditation: { description: @meditation.description, file: @meditation.file, title: @meditation.title }
    assert_redirected_to meditation_path(assigns(:meditation))
  end
